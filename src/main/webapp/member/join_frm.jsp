	...
	<h1>회원가입</h1>
		<table>
			...
			<tr>
				...
				<td><input type="text" name="name" id="name" class="inputBox" style="width: 200px" value="test"></td>
			</tr>

			<tr>
				<td><span class="required">*</span>생일</td>
				<td>
					<input type="text" name="birth" id="birth" class="inputBox"  maxlength="10" style="width: 150px" value="2000-07-13">
			</tr>
			<tr>
				<td>연락처</td>
			...
			<tr>
				...
				<td>
					...
					<select size="1" name="email2" class="inputBox" id="email2">
			...
			<tr>
				...
				<td>
					<input type="text" name="addr1" id="addr1" readonly="readonly" class="inputBox" style="width: 500px" value="test"> <br> 
					<input type="text" name="addr2" id="addr2" class="inputBox"  style="width: 500px" value="test">
				</td>
			</tr>
